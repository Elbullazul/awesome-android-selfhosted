...
- Jellyfin:
  ...
  - Symfonium ([Play Store](https://play.google.com/store/apps/details?id=app.symfonik.music.player) - *music only*)
- Subsonic:
...
- Nextcloud Passwords:
  ...
  - NextPass ([IzzyOnDroid](https://apt.izzysoft.de/fdroid/index/apk/eu.seldon1000.nextpass))
